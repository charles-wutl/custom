function mCommon_basicMessageEnter(options) {
    ...
    //定义变量
    this.colorArr = ['#15bae3', '#cf76c7', '#ffa414', '#14c89b', '#50aff3', '#e66b9e', '#ff9318', '#adcb1b'];
    ...
    this.itemSize = function () {
        ...
        this.swiperBox.find(".mCommon_basicMessageEnter_container").css("margin-top", marginTop);//垂直居中
    };
    /*init*/
    this.init = function () {
